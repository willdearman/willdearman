---
layout: post
title: Instapaper versus Pocket in 2016
categories: [products I use]
tags: [productivity]
published: True
---

Several weeks ago Instapaper announced they had been acquired by Pinterest. A fair amount of negativity was expressed by the community, which the employees attempted to temper. Now that the initial excitement has subsided, I want to review the two relative to my current workflow.

## My Objective
Like many people I read quite a bit of text content on the web, and have some desire to save what I read for future reference. What I want to save can range from specific facts, to how-to articles, to general background on subjects. Generally speaking, I'm looking for a futureproof [commonplace book](http://thoughtcatalog.com/ryan-holiday/2013/08/how-and-why-to-keep-a-commonplace-book/) that requires very little time to maintain. This is an actual use case as on a not infrequent basis I do find myself referring to my personal knowledgebase to find related ideas.
...
1. I encounter an artcile or post I don't have time to read in the present, and I want to save it for later reading;
2. To find the article or post at some indefinite future point, I need a tag and folder system;
3. When I read the article, I want to be able to highlight specific sections to retain indefinitely;
4. I need to combat byte-rot (infotmation is taken offline with no redirect) because I may refer to it years later;
...
One related workflow I tried was sending the posts either in a digest or individually to Kidle. This has the benefit of being easier on the eyes, and being usable on a more durable device. Interestingly, it is possible to highlight text on the Kindle, but unfortunately it is cumbersome (though not impossible) to get the highlights into Evernote.
...
2. My method of turning highlights into shares is really just a workaround. I have not found a way to future abstract the highlights into a useful format (e.g. a single Evernote note) without significant manual effort.
